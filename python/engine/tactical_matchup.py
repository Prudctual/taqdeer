...
TEAM_STYLE_MAP: Dict[str, Dict[str, str]] = {
    ...
    # -------------------------------------------------------------
    # 8. Turkish Süper Lig (tur1)
    # -------------------------------------------------------------
    "galatasaray": {"formation": "4-2-3-1", "style": "الضغط العالي والسيطرة الهجومية الكاسحة"},
    "fenerbahce": {"formation": "4-2-3-1", "style": "الهجوم السريع والضغط المتواصل والكرات الثابتة"},
    "besiktas": {"formation": "4-2-3-1", "style": "التوازن الهجومي والمهارات الفردية"},
    "samsunspor": {"formation": "4-2-3-1", "style": "الانضباط الدفاعي الصلب والمرتدات الصاعقة"},
    "trabzonspor": {"formation": "4-3-3", "style": "المرتدات السريعة والتكتل الإقليمي الحماسي"},
    "eyupspor": {"formation": "4-3-3", "style": "الاستحواذ المفاجئ والجرأة الهجومية"},
    "goztepe": {"formation": "3-5-2", "style": "الضغط البدني العالي والالتحامات القوية"},
    "basaksehir": {"formation": "4-3-3", "style": "الاستحواذ الهادئ وتدوير الكرة التموضعي"},
    "sivasspor": {"formation": "4-1-4-1", "style": "التكتل الدفاعي المحكم واللعب البدني"},
    "kasimpasa": {"formation": "4-1-4-1", "style": "المباريات المفتوحة والهجوم والكر والفر"},
    "antalyaspor": {"formation": "4-2-3-1", "style": "الاستحواذ المتوازن واللعب على الأطراف"},
    "konyaspor": {"formation": "4-2-3-1", "style": "التراجع الدفاعي والاعتماد على الكرات الثابتة"},
    "ri доку": {"formation": "4-2-3-1", "style": "المرتدات السريعة والتحولات الفردية"},
    "alanyaspor": {"formation": "4-2-3-1", "style": "البناء من الخلف مع مخاطرة بالتمرير"},
    "gaziantep": {"formation": "4-2-3-1", "style": "التكتل الدفاعي المنخفض والقتال"},
    "kayserispor": {"formation": "4-2-3-1", "style": "اللعب المباشر والاعتماد على الأخطاء"},
    "bodrum": {"formation": "4-2-3-1", "style": "التكتل الدفاعي الصارم وشح الأهداف"},
    "hatayspor": {"formation": "4-3-3", "style": "التراجع الدفاعي والضعف في صناعة الفرص"},
    "adanademirspor": {"formation": "4-3-3", "style": "الهشاشة التكتيكية والتراجع البدني الحاد"},

    # -------------------------------------------------------------
    # 9. Norwegian Eliteserien (no1)
    # -------------------------------------------------------------
    "bodoglimt": {"formation": "4-3-3", "style": "الضغط العالي جداً والسرعة الخاطفة في التحول"},
    "brann": {"formation": "4-3-3", "style": "الضغط الهجومي المكثف والسيطرة على الكرة"},
    "viking": {"formation": "4-3-3", "style": "الهجوم المباشر والكرات العرضية والاندفاع"},
    "molde": {"formation": "3-5-2", "style": "الاستحواذ التكتيكي والخبرة في المباريات الكبرى"},
    "rosenborg": {"formation": "4-3-3", "style": "السرعة الشبابية والتحول الهجومي المستمر"},
    "fredrikstad": {"formation": "3-5-2", "style": "الدفاع المنخفض والتكتل المباشر والصلابة التكتيكية"},
    "stromsgodset": {"formation": "3-4-3", "style": "اللعب المباشر والقوة على الكرات الثانية"},
    "kfum": {"formation": "3-4-2-1", "style": "التمرير القصير والتماسك الدفاعي المنظم"},
    "sarpsborg": {"formation": "4-2-3-1", "style": "المواجهات المفتوحة والاندفاع الهجومي المتبادل"},
    "sandefjord": {"formation": "4-3-3", "style": "الاستحواذ الشجاع مع مخاطرة بالكرات المقطوعة"},
    "kristiansund": {"formation": "4-3-3", "style": "القتال البدني والتكتل الدفاعي في الكرات الثابتة"},
    "tromso": {"formation": "3-5-2", "style": "التراجع الدفاعي الصارم والكرات المرتدة"},
    "hamkam": {"formation": "3-5-2", "style": "الكرات الثابتة والرميات الطويلة والتكتل"},
    "haugesund": {"formation": "4-3-3", "style": "الصلابة الدفاعية واللعب المباشر"},
    "lillestrom": {"formation": "4-3-3", "style": "الضغط البدني والكرات الهوائية"},
    "odd": {"formation": "4-3-3", "style": "التراجع المنظم والبطء في البناء"},
}
