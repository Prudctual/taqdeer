      ...
      <div className="sidebar-footer space-y-2 pt-3 border-t border-line">
        ...
        <div className="flex items-center gap-2 pt-1">
          <button
            ...
            className="sidebar-btn-icon flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-xl border border-line bg-surface hover:bg-panel text-xs font-bold text-ink transition-colors cursor-pointer"
          >
            {mode === "dark" ? (
              <>
          ...
          <button
            ...
            className="sidebar-btn-icon p-2 rounded-xl border border-line bg-surface hover:bg-panel text-muted hover:text-ink transition-colors cursor-pointer"
            title="تخصيص المظهر"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
