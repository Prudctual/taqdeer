      ...
      <div className="mx-auto max-w-[var(--content-max)] px-4">
        ...
        <div className="flex items-center justify-between gap-3 h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="group press-scale flex items-center gap-1.5 rounded-xl bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/30 px-3 py-1.5 text-xs font-black text-sky-600 dark:text-sky-400 no-underline transition-all shadow-xs"
        ...
        <nav className="md:hidden flex items-center gap-1.5 overflow-x-auto scrollbar-none py-2 border-t border-line/60">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="topbar-mobile-link shrink-0 flex items-center gap-1 bg-sky-500/10 text-sky-600 dark:text-sky-400 font-black border border-sky-500/30 no-underline"
          >
