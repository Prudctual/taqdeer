            ...
            <DayRail>
              <div className="bg-panel rounded-2xl px-4 py-2.5 flex items-center justify-between border border-line">
                <div className="flex items-center gap-2">
                  {day.relative ? (
                    <span className="bg-accent-dim text-accent px-3 py-0.5 rounded-full text-xs font-semibold border border-accent/20">
                      {day.relative}
                    </span>
                  ) : null}
                  {uniformRound ? (
                    <span className="bg-panel text-ink px-2.5 py-0.5 rounded-md text-[11px] font-semibold font-mono border border-line">
                      الجولة {uniformRound}
                    </span>
                  ) : null}
                ...
                <div className="shrink-0 flex items-center gap-2">
                  <span className="text-[11px] font-semibold text-muted bg-surface px-3 py-1 rounded-full border border-line shadow-2xs">
